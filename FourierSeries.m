...
%FourierSeries function to generate coeficients of Fourier series for a given discrete data. 
...
%Fourier series for generation of temporal wave form are supported when pressure is given as: 
